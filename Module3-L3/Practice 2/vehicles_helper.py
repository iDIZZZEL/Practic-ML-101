...
def all_attrubutes_vizual(dataset, one, two, three, four):
    """ Visual presentation of all attributes in the dataset.
    
   This module shows all attributes divided into 4 parts
   for better visualization.
    ...
    Parameters:
        ...
        four: selected attributes for part four
    """
    print("Part one:"+"\n")
    df1 = dataset[one] 
    sns.pairplot(df1, kind="scatter",  hue="Class", plot_kws=dict(s=80, edgecolor="white", linewidth=2.5), palette='Set1')
    plt.show()
    print("\n")
    print("Part two:"+"\n")
    df2 = dataset[two] 
    sns.pairplot(df2, kind="scatter",  hue="Class", plot_kws=dict(s=80, edgecolor="white", linewidth=2.5), palette='Set1')
    plt.show()
    print("\n")
    print("Part three:"+"\n")
    df3 = dataset[three] 
    sns.pairplot(df3, kind="scatter",  hue="Class", plot_kws=dict(s=80, edgecolor="white", linewidth=2.5), palette='Set1')
    plt.show()
    print("\n")
    print("Part four:"+"\n")
    df4 = dataset[four] 
    sns.pairplot(df4, kind="scatter",  hue="Class", plot_kws=dict(s=80, edgecolor="white", linewidth=2.5), palette='Set1')
    plt.show()
...
def conf_matrix_plot(y_test, SVC_pred): 
    """ This module presents confusion matrix of SVC model and misclassification vehicle plot
    Parameters:
        y_test,
        SVC_pred """
    ...
    print('Misclassification vehicle plot:') 
